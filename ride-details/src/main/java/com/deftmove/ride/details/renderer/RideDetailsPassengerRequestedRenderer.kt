...
class RideDetailsPassengerRequestedRenderer(
    private val actions: Subject<PresenterAction>
) : RideDetailsBaseRenderer<RideDetailsViewModel.RideDetailsPassengerRequestedViewModel>(actions) {

    override fun bindView(
        model: RideDetailsViewModel.RideDetailsPassengerRequestedViewModel,
        finder: ViewFinder,
        ...
        finder.find<LoadingButton>(R.id.ride_details_card_renderer_primary_button).apply {
            bind(
                  R.string.ride_details_passenger_requested_primary_button,
        ...
        finder.find<LoadingButton>(R.id.ride_details_card_renderer_secondary_button).apply {
            bind(
                  R.string.ride_details_passenger_requested_secondary_button,
