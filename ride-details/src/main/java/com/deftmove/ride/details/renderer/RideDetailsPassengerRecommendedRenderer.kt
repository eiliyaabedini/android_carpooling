...
class RideDetailsPassengerRecommendedRenderer(
    private val actions: Subject<PresenterAction>
) : RideDetailsBaseRenderer<RideDetailsViewModel.RideDetailsPassengerRecommendationViewModel>(actions) {

    override fun bindView(
        model: RideDetailsViewModel.RideDetailsPassengerRecommendationViewModel,
        finder: ViewFinder,
        ...
        finder.find<LoadingButton>(R.id.ride_details_card_renderer_primary_button).apply {
            bind(R.string.ride_details_passenger_recommended_primary_button, LoadingButton.LoadingButtonType.PRIMARY)
